 ...
 */
final class SMGsonResponseBodyConverter<T> implements Converter<ResponseBody, T> {
    private final Gson gson;
    private final TypeAdapter<T> adapter;
    private final Class baseBeanClazz;

    SMGsonResponseBodyConverter(Gson gson, TypeAdapter<T> adapter, Class baseBeanClazz) {
        this.gson = gson;
